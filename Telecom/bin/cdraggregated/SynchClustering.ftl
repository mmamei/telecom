...
\includegraphics[width=0.24\columnwidth]{${dir}/clustering-assoc.png}
\includegraphics[width=0.24\columnwidth]{${dir}/clustering-blood.png}
\includegraphics[width=0.24\columnwidth]{${dir}/clustering-referendum.png}
\includegraphics[width=0.24\columnwidth]{${dir}/clustering-soccap.png}
\end{center}
