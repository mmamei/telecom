...
//	true se il comune appartiene ad una delle provice date
	public boolean isInProvince(ArrayList<Integer> provinceInConsiderazione){
	...
	//ritorna true o se la regione � piemontese, o se c� qualcuno che parte da questo comune verso il piemonte, 2)provincia di torino
