...
public class WekaUseClassifier {
	...
	public static void main(String[] args) throws Exception {
		...
		for(File f: dir.listFiles()) {
			if(f.getAbsolutePath().endsWith(".arff") && !f.getAbsolutePath().contains("maxdays")) {
				...
				if(classifier.exists()) {
					File willBeOutout = new File(f.getAbsolutePath().replace(".arff", "_classes.csv"));
					if(!willBeOutout.exists() || (willBeOutout.lastModified() < f.lastModified() && willBeOutout.lastModified() < classifier.lastModified()))
