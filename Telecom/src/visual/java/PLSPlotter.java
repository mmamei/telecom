...
public static GraphPlotter drawGraph(String title, String[] domain, double[] data, CDRTimeDensity plsmap, List<CityEvent> relevantEvents) {
	...
	public static GraphPlotter[] drawGraph(String title, String[] domain, double[] pls_data,double[] usr_data,double[] z_pls_data,double[] z_usr_data, CDRTimeDensity plsmap, List<CityEvent> relevantEvents) {
